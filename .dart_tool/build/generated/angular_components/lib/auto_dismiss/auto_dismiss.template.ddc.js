define(['dart_sdk', 'packages/angular/angular.template', 'packages/angular_components/utils/browser/events/events.template'], function(dart_sdk, packages__angular__angular$46template, packages__angular_components__utils__browser__events__events$46template) {
  'use strict';
  ...
  const auto_dismiss$46template = Object.create(dart.library);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["auto_dismiss.template.dart"],"names":[],"mappings":";;;;;;;;;;AAWE,kBAAI;AACF;;AAEa,IAAf,mCAAW;AAEU,IAArB;AACqB,IAArB;EACF;;MATI,gCAAQ;YAAG","file":"auto_dismiss.template.ddc.js"}');
  // Exports:
  return {

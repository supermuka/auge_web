define(['dart_sdk', 'packages/angular/angular.template', 'packages/angular_components/annotations/rtl_annotation.template', 'packages/angular_components/utils/browser/dom_service/angular_2.template', 'packages/angular_components/utils/disposer/disposer.template'], function(dart_sdk, packages__angular__angular$46template, packages__angular_components__annotations__rtl_annotation$46template, packages__angular_components__utils__browser__dom_service__angular_2$46template, packages__angular_components__utils__disposer__disposer$46template) {
  'use strict';
  ...
  const scorecard_bar$46template = Object.create(dart.library);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["scorecard_bar.template.dart"],"names":[],"mappings":";;;;;;;;;;;;AAaE,kBAAI;AACF;;AAEa,IAAf,oCAAW;AAEU,IAArB;AACqB,IAArB;AACqB,IAArB;AACqB,IAArB;EACF;;MAXI,iCAAQ;YAAG","file":"scorecard_bar.template.ddc.js"}');
  // Exports:
  return {

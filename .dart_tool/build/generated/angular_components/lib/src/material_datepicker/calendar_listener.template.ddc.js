define(['dart_sdk', 'packages/angular_components/material_datepicker/calendar.template', 'packages/angular_components/model/date/date.template', 'packages/angular_components/model/observable/observable.template', 'packages/angular_components/utils/disposer/disposer.template'], function(dart_sdk, packages__angular_components__material_datepicker__calendar$46template, packages__angular_components__model__date__date$46template, packages__angular_components__model__observable__observable$46template, packages__angular_components__utils__disposer__disposer$46template) {
  ...
  const calendar_listener$46template = Object.create(dart.library);
  const enum_parsing$46template = Object.create(dart.library);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["calendar_listener.template.dart","enum_parsing.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;AAaE,kBAAI;AACF;;AAEa,IAAf,wCAAW;AAEU,IAArB;AACqB,IAArB;AACqB,IAArB;AACqB,IAArB;EACF;;MAXI,qCAAQ;YAAG;;;;;ECHO","file":"calendar_listener.template.ddc.js"}');
  // Exports:
  return {

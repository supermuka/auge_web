...
import 'package:angular/src/di/injector/injector.dart' as import35;
import 'tooltip_controller.dart' as import36;
import '../../material_tooltip/module.dart' as import37;
import '../../utils/disposer/disposer.dart' as import38;

final List<dynamic> styles$MaterialInkTooltipComponent = [import0.styles];

// View for component MaterialInkTooltipComponent in asset:angular_components/lib/src/material_tooltip/ink_tooltip.dart (changeDetection: OnPush)
...
class _ViewMaterialInkTooltipComponent1 extends import13.EmbeddedView<import2.MaterialInkTooltipComponent> {
  ...
  void detectChangesInternal() {
    ...
    if (import9.checkBinding(this._expr_0, currVal_0, 'aacmtit-ink-tooltip-shadow {{popupClassName}}', '')) {
...
// Host for component MaterialInkTooltipComponent in asset:angular_components/lib/src/material_tooltip/ink_tooltip.dart (changeDetection: Default)
class _ViewMaterialInkTooltipComponentHost0 extends import34.HostView<import2.MaterialInkTooltipComponent> {
  ...
  _ViewMaterialInkTooltipComponentHost0(import35.Injector injector) : super(injector);
  @override
  void build() {
    // Child component MaterialInkTooltipComponent in asset:angular_components/lib/src/material_tooltip/ink_tooltip.dart (changeDetection: OnPush)
    this.componentView = ViewMaterialInkTooltipComponent0(this, 0);
    final _el_0 = this.componentView.rootElement;
    this._TooltipController_0_5 = (import9.isDevMode
        ? import18.debugInjectorWrap(import36.TooltipController, () {
            return import37.createTooltipController(this.injectorGetOptional(import36.TooltipController, this.parentIndex), this.injectorGetOptional(import38.Disposer, this.parentIndex));
          })
        : import37.createTooltipController(this.injectorGetOptional(import36.TooltipController, this.parentIndex), this.injectorGetOptional(import38.Disposer, this.parentIndex)));
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import36.TooltipController) && (0 == nodeIndex))) {
...
import34.HostView<import2.MaterialInkTooltipComponent> viewFactory_MaterialInkTooltipComponentHost0(import35.Injector injector) {
  return _ViewMaterialInkTooltipComponentHost0(injector);
}

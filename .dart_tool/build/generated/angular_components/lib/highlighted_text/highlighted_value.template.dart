...
import 'package:angular/src/di/injector/injector.dart' as import19;
...
// View for component HighlightedValueComponent in asset:angular_components/lib/highlighted_text/highlighted_value.dart (changeDetection: Default)
class ViewHighlightedValueComponent0 extends import1.ComponentView<import2.HighlightedValueComponent> {
  ...
  void detectChangesInternal() {
    ...
    if (import9.checkBinding(this._expr_0, currVal_0, 'segments', '')) {
...
class _ViewHighlightedValueComponent1 extends import13.EmbeddedView<import2.HighlightedValueComponent> {
  ...
  void detectChangesInternal() {
    ...
    if (import9.checkBinding(this._expr_0, currVal_0, 'segment.isHighlighted', '')) {
...
// Host for component HighlightedValueComponent in asset:angular_components/lib/highlighted_text/highlighted_value.dart (changeDetection: Default)
class _ViewHighlightedValueComponentHost0 extends import18.HostView<import2.HighlightedValueComponent> {
  _ViewHighlightedValueComponentHost0(import19.Injector injector) : super(injector);
  @override
  void build() {
    // Child component HighlightedValueComponent in asset:angular_components/lib/highlighted_text/highlighted_value.dart (changeDetection: Default)
...
import18.HostView<import2.HighlightedValueComponent> viewFactory_HighlightedValueComponentHost0(import19.Injector injector) {
  return _ViewHighlightedValueComponentHost0(injector);
}

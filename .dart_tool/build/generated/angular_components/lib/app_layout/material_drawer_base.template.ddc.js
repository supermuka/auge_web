define(['dart_sdk', 'packages/angular/angular.template', 'packages/angular_components/content/deferred_content_aware.template'], function(dart_sdk, packages__angular__angular$46template, packages__angular_components__content__deferred_content_aware$46template) {
  'use strict';
  ...
  const material_drawer_base$46template = Object.create(dart.library);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_drawer_base.template.dart"],"names":[],"mappings":";;;;;;;;;;AAWE,kBAAI;AACF;;AAEa,IAAf,2CAAW;AAEU,IAArB;AACqB,IAArB;EACF;;MATI,wCAAQ;YAAG","file":"material_drawer_base.template.ddc.js"}');
  // Exports:
  return {

define(['dart_sdk', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/bootstrap/modules', 'packages/angular/src/core/change_detection/directive_change_detector', 'packages/angular_components/app_layout/material_persistent_drawer', 'packages/angular_components/app_layout/material_drawer_base.template', 'packages/angular/angular.template', 'packages/angular_components/content/deferred_content_aware.template'], function(dart_sdk, packages__angular__src__core__change_detection__change_detection, packages__angular__src__bootstrap__modules, packages__angular__src__core__change_detection__directive_change_detector, packages__angular_components__app_layout__material_persistent_drawer, packages__angular_components__app_layout__material_drawer_base$46template, packages__angular__angular$46template, packages__angular_components__content__deferred_content_aware$46template) {
  'use strict';
  ...
  const material_persistent_drawer$46template = Object.create(dart.library);
  const CT = Object.create(null);
  const _expr_0 = dart.privateName(material_persistent_drawer$46template, "_expr_0");
  const _expr_1 = dart.privateName(material_persistent_drawer$46template, "_expr_1");
  const instance$ = dart.privateName(material_persistent_drawer$46template, "MaterialPersistentDrawerDirectiveNgCd.instance");
  ...
  dart.setLibraryUri(material_persistent_drawer$46template.MaterialPersistentDrawerDirectiveNgCd, "package:angular_components/app_layout/material_persistent_drawer.template.dart");
  dart.setFieldSignature(material_persistent_drawer$46template.MaterialPersistentDrawerDirectiveNgCd, () => ({
    ...
    instance: dart.finalFieldType(material_persistent_drawer.MaterialPersistentDrawerDirective),
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_persistent_drawer.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;IAiBkD;;;;;;sBAIN,MAAsB;AACxD,sBAAiB,AAAS;AAChC,oBAAI,2BAA0B,eAAS,SAAS,EAAE,MAAM;AACkB,QAAxE,sCAAkC,EAAE,EAAE,wBAAwB,SAAS;AAC/C,QAAnB,gBAAU,SAAS;;AAEpB,sBAAiB,AAAS;AAChC,oBAAI,2BAA0B,eAAS,SAAS,EAAE,MAAM;AACiB,QAAvE,sCAAkC,EAAE,EAAE,uBAAuB,SAAS;AAC9C,QAAnB,gBAAU,SAAS;;IAE5B;;8FAZ2C;IAFtC;IACA;IACsC;;EAAS;;;;;;;;;;;;;;AAiBpD,kBAAI;AACF;;AAEa,IAAf,iDAAW;AAEU,IAArB;AACqB,IAArB;AACqB,IAArB;EACF;;MAVI,8CAAQ;YAAG","file":"material_persistent_drawer.template.ddc.js"}');
  // Exports:
  return {

define(['dart_sdk', 'packages/angular/angular.template', 'packages/angular_components/utils/browser/dom_service/angular_2.template'], function(dart_sdk, packages__angular__angular$46template, packages__angular_components__utils__browser__dom_service__angular_2$46template) {
  'use strict';
  ...
  const showhide$46template = Object.create(dart.library);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["showhide.template.dart"],"names":[],"mappings":";;;;;;;;;;AAWE,kBAAI;AACF;;AAEa,IAAf,+BAAW;AAEU,IAArB;AACqB,IAArB;EACF;;MATI,4BAAQ;YAAG","file":"showhide.template.ddc.js"}');
  // Exports:
  return {
